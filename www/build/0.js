...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__student_list__ = __webpack_require__(767);
...
var StudentListPageModule = (function () {
    ...
    StudentListPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["J" /* NgModule */])({
            ...
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__student_list__["a" /* StudentListPage */]),
            ],
            exports: [
                __WEBPACK_IMPORTED_MODULE_2__student_list__["a" /* StudentListPage */]
            ]
...
var StudentListPage = (function () {
    function StudentListPage(navCtrl, navParams, http, loadingCtrl) {
        this.navCtrl = navCtrl;
    ...
    StudentListPage.prototype.ionViewDidEnter = function () {
        var _this = this;
        ...
        this.http.get('school/studentList.do?id=' + this.classInfo.id).subscribe(function (data) {
            if (data.students) {
    ...
    StudentListPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'page-student-list',template:/*ion-inline-start:"C:\WorkSpaceCampus\school\src\pages\school\student-list\student-list.html"*/'<!--\n  Generated template for the StudentListPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n    <ion-navbar>\n        <ion-title>学生</ion-title>\n    </ion-navbar>\n\n</ion-header>\n\n\n<ion-content>\n    <ion-list>\n        <ion-item *ngFor="let student of students">\n            <span class="student-img"><img *ngIf="student.photo" src="{{student.photo}}"></span>\n            <span>{{student.name}}</span>\n            <span>{{student.sex |sex}}</span>\n        </ion-item>\n    </ion-list>\n\n</ion-content>'/*ion-inline-end:"C:\WorkSpaceCampus\school\src\pages\school\student-list\student-list.html"*/,
        }),
