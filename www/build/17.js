...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__identity__ = __webpack_require__(739);
...
var IdentityPageModule = (function () {
    function IdentityPageModule() {
    }
    IdentityPageModule = __decorate([
...
var IdentityPage = (function () {
    function IdentityPage(navCtrl, navParams, http) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.http = http;
    }
    IdentityPage.prototype.ionViewDidLoad = function () {
        var _this = this;
        this.http.get('school/loadMembers.do').subscribe(function (data) {
            if (data.members) {
    ...
    IdentityPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'page-identity',template:/*ion-inline-start:"C:\WorkSpaceCampus\school\src\pages\my\identity\identity.html"*/'<!--\n  Generated template for the IdentityPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n    <ion-navbar>\n        <ion-title>身份</ion-title>\n    </ion-navbar>\n\n</ion-header>\n\n\n<ion-content>\n\n    <ion-list radio-group class="role-wrap mtop">\n        <ion-item *ngFor="let member of members">\n            <ion-label>\n                <div class="role {{member.cls}}">{{member.name}}</div>\n            </ion-label>\n            <ion-radio checked="{{member.isCheck}}" value="{{member.id}}"></ion-radio>\n        </ion-item>\n    </ion-list>\n\n    <div style="margin: 20px 10px 0 10px;">\n        <button ion-button block color="secondary">切换</button>\n    </div>\n\n</ion-content>'/*ion-inline-end:"C:\WorkSpaceCampus\school\src\pages\my\identity\identity.html"*/,
        }),
