...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__school__ = __webpack_require__(765);
    ...
    SchoolPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["J" /* NgModule */])({
            ...
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__school__["a" /* SchoolPage */]),
            ],
        })
    ], SchoolPageModule);
...
var SchoolPage = (function () {
    function SchoolPage(navCtrl, navParams, storage, http) {
        this.navCtrl = navCtrl;
    ...
    SchoolPage.prototype.ionViewDidLoad = function () {
        var _this = this;
        this.http.get('app/function/loadBySchool.do').subscribe(function (data) {
            if (data.funs) {
                _this.funs = data.funs;
                if (_this.school && _this.school.id) {
                    _this.storage.write(_this.school.id + '_funs', data.funs);
                }
            }
        });
    };
    SchoolPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'page-school',template:/*ion-inline-start:"C:\WorkSpaceCampus\school\src\pages\school\school\school.html"*/'<ion-header>\n\n    <ion-navbar>\n        <ion-title>校园</ion-title>\n    </ion-navbar>\n\n</ion-header>\n\n\n<ion-content>\n    <ul class="tool-box white-bg">\n        <li *ngFor="let fun of funs">\n            <a tappable href="javascript:;" link="{{fun.url}}" *ngIf="fun.needAuth==1" [params]="fun" auth="true">\n                <img src="{{fun.logo}}">\n                <label>{{fun.name}}</label>\n            </a>\n            <a tappable href="javascript:;" link="{{fun.url}}" *ngIf="fun.needAuth==0" [params]="fun">\n                <img src="{{fun.logo}}">\n                <label>{{fun.name}}</label>\n            </a>\n        </li>\n    </ul>\n</ion-content>'/*ion-inline-end:"C:\WorkSpaceCampus\school\src\pages\school\school\school.html"*/,
        }),
