...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__chat__ = __webpack_require__(769);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__component_component_module__ = __webpack_require__(770);
...
var ChatPageModule = (function () {
    ...
    ChatPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["J" /* NgModule */])({
            ...
            imports: [
                __WEBPACK_IMPORTED_MODULE_3__component_component_module__["a" /* ComponentsModule */],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_jquery__ = __webpack_require__(734);
...
var ChatPage = (function () {
    function ChatPage(navCtrl, navParams, renderer, fb, chatService, cd) {
    ...
    ChatPage.prototype.ionViewDidEnter = function () {
        ...
        this.chatService.loadMessages(this.conversation.id, null).then(function (data) {
            console.log('messages=======>' + JSON.stringify(data));
            _this.pushMsg(data);
        });
    };
    ChatPage.prototype.pushMsg = function (data) {
    ...
    ChatPage.prototype.insertFace = function (src) {
        this.input.insertImg(src, 'face');
    };
    ChatPage.prototype.toggleFace = function () {
        if (__WEBPACK_IMPORTED_MODULE_3_jquery___default()('.face-items').is(':visible')) {
            __WEBPACK_IMPORTED_MODULE_3_jquery___default()('.face-items').hide();
        }
        else {
            __WEBPACK_IMPORTED_MODULE_3_jquery___default()('.face-items').show();
        }
        this.contentComponent.resize();
    };
    ChatPage.prototype.hideFace = function () {
        __WEBPACK_IMPORTED_MODULE_3_jquery___default()('.face-items').hide();
        this.contentComponent.resize();
    };
    ChatPage.prototype.scrollToBottom = function () {
        var _this = this;
        setTimeout(function () {
            _this.contentComponent.scrollToBottom();
        }, 200);
    };
    ChatPage.prototype.onSubmit = function () {
        var content = this.form.value.content;
        var encodeContent = this.encodeMsgContent(content);
        var msg = {
            fromUserId: 'test',
    ...
    ChatPage.prototype.encodeMsgContent = function (content) {
        var _this = this;
    ...
    ChatPage.prototype.decodeMsgContent = function (content) {
        var _this = this;
        if (content === void 0) { content = ''; }
    ...
    ChatPage.prototype.setFocus = function () {
        var _this = this;
        setTimeout(function () {
            _this.renderer.invokeElementMethod(_this.input.input.nativeElement, 'focus');
        }, 0);
    };
    ChatPage.prototype.setBlur = function () {
        var _this = this;
        setTimeout(function () {
            _this.renderer.invokeElementMethod(_this.input.input.nativeElement, 'blur');
        }, 0);
    };
    ChatPage.prototype.onInputFocus = function () {
        //this.hideFace();
    };
    ChatPage.prototype.onInputResize = function () {
        this.contentComponent.resize();
    };
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_9" /* ViewChild */])('input'),
    ...
    __decorate([
        ...
        __metadata("design:type", Object)
    ], ChatPage.prototype, "contentComponent", void 0);
    ChatPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'page-chat',template:/*ion-inline-start:"C:\WorkSpaceCampus\school\src\pages\talk\chat\chat.html"*/'<ion-header>\n    <ion-navbar>\n        <ion-title>{{name}}</ion-title>\n    </ion-navbar>\n</ion-header>\n\n<ion-content scrollDownOnLoad="true">\n    <div class="chat-msg-wrap" *ngFor="let msg of msgList">\n        <div class="msg-time">\n            <span>{{msg.time}}</span>\n        </div>\n        <div class="msg-wrap {{msg.fromUser == ownerId ? \'my-msg\' : \'other-msg\'}}">\n            <ion-thumbnail>\n                <img src="{{msg.image}}" />\n            </ion-thumbnail>\n            <div class="msg-content">\n                <p [innerHTML]="decodeMsgContent(msg.content)"></p>\n            </div>\n        </div>\n    </div>\n</ion-content>\n\n<ion-footer>\n    <div class="chat-bar">\n        <form [formGroup]="form">\n            <content-input #input formControlName="content" (submit)="onSubmit()" (focus)="onInputFocus()" (resize)="onInputResize()"></content-input>\n            <div class="tool-bar">\n                <a href="javascript:void(0);" class="tool-btn" (click)="toggleFace()">\n                    <img src="assets/images/talk/chat/emoji.png" />\n                </a>\n            </div>\n        </form>\n    </div>\n    <div class="face-items">\n        <div>\n            <span *ngFor="let item of faceItems;" (click)="insertFace(item.src)">\n                <img src="{{item.src}}" />\n            </span>\n        </div>\n    </div>\n</ion-footer>'/*ion-inline-end:"C:\WorkSpaceCampus\school\src\pages\talk\chat\chat.html"*/,
        }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__content_input_content_input__ = __webpack_require__(771);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ComponentsModule = (function () {
    ...
    ComponentsModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["J" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_1__content_input_content_input__["a" /* ContentInputComponent */]
            ],
            imports: [],
            exports: [
                __WEBPACK_IMPORTED_MODULE_1__content_input_content_input__["a" /* ContentInputComponent */]
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_jquery__ = __webpack_require__(734);
...
var ContentInputComponent = (function () {
    function ContentInputComponent(renderer) {
        this.renderer = renderer;
        this._onChange = function (value) { };
        this.focus = new __WEBPACK_IMPORTED_MODULE_0__angular_core__["w" /* EventEmitter */]();
        this.submit = new __WEBPACK_IMPORTED_MODULE_0__angular_core__["w" /* EventEmitter */]();
        this.resize = new __WEBPACK_IMPORTED_MODULE_0__angular_core__["w" /* EventEmitter */]();
        this.height = 0;
    }
    ...
    ContentInputComponent.prototype.computerSize = function (el) {
        var h = __WEBPACK_IMPORTED_MODULE_2_jquery___default()(el).height();
        if (h != this.height) {
            this.height = h;
            this.resize.emit();
        }
    };
    ContentInputComponent.prototype.insertImg = function (src, cls) {
    ...
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["P" /* Output */])('focus'),
        __metadata("design:type", Object)
    ], ContentInputComponent.prototype, "focus", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["P" /* Output */])('submit'),
        __metadata("design:type", Object)
    ], ContentInputComponent.prototype, "submit", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["P" /* Output */])('resize'),
        __metadata("design:type", Object)
    ], ContentInputComponent.prototype, "resize", void 0);
    ContentInputComponent = ContentInputComponent_1 = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'content-input',template:/*ion-inline-start:"C:\WorkSpaceCampus\school\src\component\content-input\content-input.html"*/'<div contenteditable="true" #input (click)="saveLastEditRange()" (keyup)="saveLastEditRange()" (keypress)="onKeypress($event);" (input)="onInput($event)" (focus)="focus.emit($event)"></div>'/*ion-inline-end:"C:\WorkSpaceCampus\school\src\component\content-input\content-input.html"*/,
            providers: [
                { provide: __WEBPACK_IMPORTED_MODULE_1__angular_forms__["c" /* NG_VALUE_ACCESSOR */], useExisting: Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_15" /* forwardRef */])(function () { return ContentInputComponent_1; }), multi: true }
            ]
        }),
