...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ClassActivityListPageModule", function() { return ClassActivityListPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(44);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__class_activity_list__ = __webpack_require__(755);
...
var ClassActivityListPageModule = (function () {
    function ClassActivityListPageModule() {
    }
    ClassActivityListPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["J" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__class_activity_list__["a" /* ClassActivityListPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_3__directives__["a" /* DirectiveModule */],
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__class_activity_list__["a" /* ClassActivityListPage */]),
            ],
            exports: [
                __WEBPACK_IMPORTED_MODULE_2__class_activity_list__["a" /* ClassActivityListPage */]
            ]
        })
    ], ClassActivityListPageModule);
    return ClassActivityListPageModule;
}());

//# sourceMappingURL=class-activity-list.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ClassActivityListPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(44);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers__ = __webpack_require__(60);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
 ...
 */
var ClassActivityListPage = (function () {
    function ClassActivityListPage(navCtrl, navParams, http) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.http = http;
        this.classInfo = this.navParams.data;
    }
    ClassActivityListPage.prototype.ionViewDidEnter = function () {
        var _this = this;
        this.http.get('school/loadClassActivities.do?classId=' + this.classInfo.code).subscribe(function (data) {
            if (data.classActivities) {
                _this.activities = data.classActivities;
            }
        });
    };
    ClassActivityListPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'page-class-activity-list',template:/*ion-inline-start:"C:\WorkSpaceCampus\school\src\pages\school\class-activity-list\class-activity-list.html"*/'<!--\n  Generated template for the ClassActivityListPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n    <ion-navbar>\n        <ion-title>班级活动</ion-title>\n    </ion-navbar>\n\n</ion-header>\n\n\n<ion-content>\n\n    <ion-card *ngFor="let activity of activities" link="school/classActivity" [params]="activity">\n        <img src="{{activity.imageUrl}}" />\n        <div class="card-title">{{activity.title}}</div>\n        <div class="card-time">{{activity.insertTime}}</div>\n    </ion-card>\n\n</ion-content>'/*ion-inline-end:"C:\WorkSpaceCampus\school\src\pages\school\class-activity-list\class-activity-list.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* NavParams */],
            __WEBPACK_IMPORTED_MODULE_2__providers__["f" /* HttpService */]])
    ], ClassActivityListPage);
    return ClassActivityListPage;
}());

//# sourceMappingURL=class-activity-list.js.map
